(function (global) {
  ...
  function seedOrders() {
    ...
    function O(no, type, title, desc, address, price, people, urgent, minutesAgo, iso, authorIdx, showPhone, phone, status, responses, reviews, city) {
      var a = A(authorIdx);
      return {
        id: 'o_' + no,
        type: type,
    ...
    return [
      ...
      O(9, 'Грузчики', 'Такелаж холодильника и стиральной машины', 'Нужно поднять холодильник и стиральную машину на 4 этаж без лифта и поставить на место.', 'Санкт-Петербург, ул. Чехова, 5, кв. 12', 1500, 1, true, 800, d(today, 15, 0), 9, true, '+7 934 567-89-01', 'open', [], [], 'Санкт-Петербург'),
      O(10, 'Другое', 'Помощь в выносе хлама с дачи', 'Помочь вынести старую мебель и хлам из дома на участок, погрузить в прицеп.', 'Казань, СНТ «Берёзка», уч. 32', 2000, 2, false, 1500, d(tomorrow, 12, 0), 10, false, '', 'open', [], [], 'Казань'),
      O(11, 'Уборка', 'Мойка окон в квартире', 'Помыть окна в 3-комнатной квартире, 8 окон + балкон.', 'Санкт-Петербург, ул. Пушкина, 8, кв. 3', 2500, 1, false, 2100, d(today, 17, 0), 11, false, '', 'open', [], [], 'Санкт-Петербург'),
      ...
      O(14, 'Водитель', 'Водитель с машиной на день (грузоперевозки)', 'Нужен водитель со своим авто (универсал или грузовой) на 8 часов: доставка мебели и развоз по 3 адресам. Оплата по часам.', base + ', склад «Депо», ул. Электролитный пр-д, 3', 9000, 1, true, 900, d(tomorrow, 9, 0), 12, true, '+7 945 678-90-12', 'open')
    ];
  }
